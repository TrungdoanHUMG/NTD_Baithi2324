...
namespace NTD_Baithi2324.Controllers
{
    public class PersonController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PersonID,FullName,Diachi")] Person person)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("PersonID,FullName,Diachi")] Person person)
        {
